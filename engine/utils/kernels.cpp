...
float SpikyKernel::m_radius = 0.0f;
float SpikyKernel::m_k = 0.0f;
float SpikyKernel::m_l = 0.0f;
float SpikyKernel::m_W_zero = 0.0f;

float SpikyKernel2D::m_radius = 0.0f;
float SpikyKernel2D::m_k = 0.0f;
float SpikyKernel2D::m_l = 0.0f;
float SpikyKernel2D::m_W_zero = 0.0f;
