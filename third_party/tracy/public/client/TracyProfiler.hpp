...
public:
    ...
    static tracy_force_inline int64_t GetTimeFallback()
    {
...
#  endif
    ...
    static tracy_force_inline bool ForceFallbackTimer()
    {
#  ifdef TRACY_FORCE_FALLBACK
        return true;
#  else
        static const bool force = []() {
            const char* env = GetEnvVar( "TRACY_FORCE_FALLBACK" );
            return env && env[0] == '1';
        }();
        return force;
#  endif
    ...
    {
        if( ForceFallbackTimer() ) return GetTimeFallback();
